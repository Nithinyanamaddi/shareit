...
public class MainActivity2 extends AppCompatActivity {
    ...
    user_adapter.OnUserClickListener onUserClickListener;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        onUserClickListener = new user_adapter.OnUserClickListener() {
            @Override
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if(item.getItemId()==R.id.menu_item_profile){
            startActivity(new Intent(MainActivity2.this, ContactsContract.Profile.class));
        }
    ...
    private void getUsers(){
        ...
        FirebaseDatabase.getInstance().getReference("user").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                user_adapter=new user_adapter(users,MainActivity2.this,onUserClickListener);
